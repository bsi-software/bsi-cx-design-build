...
module.exports = cx.templateElement
    ...
    .withTemplateParts(
        ...
        cx.templatePart.PlainText("Plain text", "plain-text-Y3dhVu"),
        cx.templatePart.MultilinePlainText("Multiline plain text", "multiline-plain-text-0pQpp9"),
        cx.templatePart.FormattedText("Formatted text", "formatted-text-fC3iJv", require("../../../html-editor-configs/full")),
